                        ...
                        <td className="p-5">
                          <div className="flex justify-center gap-3">
                            <button
                              ...
                              className="bg-yellow-500 hover:bg-yellow-600 text-white p-2.5 rounded-xl shadow hover:scale-110 transition"
                            >
                              <Pencil size={18} />
                            </button>
                            <button
                              onClick={() => handleDelete(employee.id)}
                              className="bg-red-600 hover:bg-red-700 text-white p-2.5 rounded-xl shadow hover:scale-110 transition"
                            >
                              <Trash2 size={18} />
                            </button>
                          </div>
