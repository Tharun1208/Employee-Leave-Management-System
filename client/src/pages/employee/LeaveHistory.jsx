        ...
        <main className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="hidden sm:flex w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-white/20 items-center justify-center backdrop-blur-sm transition-all duration-500 group-hover:rotate-12 group-hover:scale-110">
                <History size={40} className="lg:w-[42px] lg:h-[42px]" />
              </div>
            </div>
          </div>
                        ...
                        >
                          ...
                          <td className="p-4 text-center">
                            <button
                              ...
                              className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-blue-100 hover:bg-blue-700 hover:text-white flex items-center justify-center mx-auto transition-all duration-300 hover:scale-110"
                            >
                              <Eye size={20} />
                            </button>
                          </td>
          ...
          <div className="bg-white w-full max-w-xl max-h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-5 sm:p-8 space-y-5 overflow-y-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <button
                  onClick={() => setSelectedLeave(null)}
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-700 to-indigo-700 hover:from-blue-800 hover:to-indigo-800 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  Close
                </button>
              </div>
